			...
			<nav class="navbar navbar-expand navbar-light navbar-bg">
				...
				<div class="navbar-collapse collapse">
					<ul class="navbar-nav navbar-align">
							<a class=" d-sm-inline-block" href="#" data-bs-toggle="dropdown">
					...
					<div class="row">
						...
						<div class="col-md-8 col-xl-9">
                            ...
                            <div class="m-sm-2">
									...
									<div class="mb-3">
											<label class="form-label">Business Complete Address</label>
											<input class="form-control form-control-lg mb-1" type="text" name="add1" Placeholder="Building No./House No./Unit No." />
                                            <input class="form-control form-control-lg mb-1" type="text" name="add2"  Placeholder="Street/Barangay" />
                                            <input class="form-control form-control-lg" type="text" name="add3" Placeholder="City/Municipality"  />
										</div>
