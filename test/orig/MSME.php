...
<body>
 ...
 {
	$ID2=$row1['ID'];
	  $query2="SELECT * FROM `businessProfile` Where ID =$ID2";
	  $result2=mysqli_query($con,$query2);
  while($row2=mysqli_fetch_array($result2)){
	$ID3=$row2['businessID'];
	$query3="SELECT * FROM `application` Where businessID =$ID3";
    ...
    <tr>
      ...
      <td>	<a href="viewProfile.php?ID=<?php echo $row1['ID']; ?>"><?php echo $row2['businessName']; ?></a></td>
      <td><?php echo $row2['natureOfBusiness']; ?></td>
      <td><?php
                                           	$succes = "<span class='badge bg-success'>";
                                           	$succes1="</span>"; 
                                           ...
                                           if($row3['status'] == '1'){
                                            echo $pending."On Process".$succes1="</span>";}
                                           else if($row3['status'] == '0'){
                                           	echo $danger."No Application".$danger1="</span>";
                                           }
										   else{
											echo $succes."Approve".$danger1="</span>";
										   }
