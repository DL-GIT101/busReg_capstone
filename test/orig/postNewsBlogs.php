...
if(isset($_POST['post'])){
    ...
    $con->query("INSERT INTO newsblog (businessID,title,content,image) VALUES ('$locationId', '$title', '$content','$image')");
    move_uploaded_file($_FILES['image']['tmp_name'], $target);
    header("location: MSMEdashboard1.php?userID=".$id);
    }
?>
<!DOCTYPE html>
<html lang="en">
						...
						<div class="col-md-8 col-xl-9">
								...
								<div class="m-sm-4">
									...
									<form class="widget-form" id="login-form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="text-center mt-3">
											<button type="button" class="btn btn-lg btn-primary" Value="Upload" onclick="history.back()">Go back</button></br>
